...
//
//#include "Drawer.h"
//#include "core/app/DebugInfo.h"
//#include "core/platform/InputEvents.h"
//#include "core/file_system/Legacy.h"
...
//			name{ name },
//			data{ HT::FS::read_asset("fonts/" + name + ".ttf") },
//			size{ size }
//		{
...
//		 */
//		Gui(VulkanSample<vkb::BindingType::C>& app, const Window& window, const float font_size = 21.0f, bool explicit_update = false);
//
//		/**
...
//
//		VulkanSample<vkb::BindingType::C>& app;
//
